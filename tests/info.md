...
- Exportadores y jerarquía documental (`test_reporters.py`, `test_html_export.py`), incluyendo validaciones de capa semántica común, bloque meta completo, presencia de periodo visible en Word/PDF/HTML/Excel, fallback `No disponible` cuando faltan fechas y consolidación de contenido por URL.
