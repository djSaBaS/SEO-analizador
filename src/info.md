...
- `seo_auditor/reporters.py`: exportación a JSON, Excel, Word, PDF, HTML y Markdown, incluyendo capa semántica intermedia única para alinear DOCX/PDF/HTML, sanitización editorial, política de emojis basada en texto seguro, limpieza de placeholders, consolidación de hoja `Contenido` por URL en Excel y helper DRY de resolución de periodo analizado.
