...
## Estado de fase
- Ajuste documental (2026-04-01): se incorpora `informe_service.py` para centralizar la construcción del modelo semántico, el orden editorial de secciones y reglas condicionales por fuentes (GSC/GA4/IA), dejando Markdown IA como artefacto auxiliar.
